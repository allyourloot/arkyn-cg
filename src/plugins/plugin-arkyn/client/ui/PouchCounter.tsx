...
import { usePouchSize, useAcquiredRunes } from "../arkynStore";
...
export default function PouchCounter() {
    ...
    // Total deck size grows past POUCH_SIZE as the player picks runes
    // from Rune Bags — each acquired rune adds one permanent slot.
    const deckSize = POUCH_SIZE + acquiredRunes.length;
