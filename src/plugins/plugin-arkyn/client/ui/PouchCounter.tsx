...
export default function PouchCounter() {
    ...
    // Total deck size is POUCH_SIZE for Standard. When modifier-bearing
    // spellbooks land this should come from the spellbook definition (or
    // from a per-player field on ArkynPlayerState).
    const deckSize = POUCH_SIZE;
