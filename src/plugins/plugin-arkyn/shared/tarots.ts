...
// See `shared/rngNamespace.ts` for the full namespace map.
export const AUGURY_PACK_RNG_OFFSET = RNG_NAMESPACES.auguryPack;
...
export const TAROT_DEFINITIONS: Record<string, TarotDefinition> = {
    ...
    the_hierophant: {
        ...
        name: "The Hierophant",
        number: "V",
        description: "Convert up to 2 runes to a chosen element AND upgrade their rarity by 1 tier.",
    ...
    the_tower: {
        ...
        name: "The Tower",
        number: "XVI",
        description: "Banish up to 2 runes; gain {gold:2} per banished rune.",
