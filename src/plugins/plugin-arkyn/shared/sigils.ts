...
export const SIGIL_DEFINITIONS: Record<string, SigilDefinition> = {
    ...
    fortune: {
        ...
        name: "Fortune",
        rarity: "uncommon",
        description: "Critical runes have a {1 in 3} chance to grant {gold:2}.",
        cost: 4,
        sellPrice: 2,
    },
    fuze: {
    ...
    plunder: {
        ...
        name: "Plunder",
        rarity: "common",
        description: "Earn {gold:5} at the end of each round.",
        cost: 3,
        sellPrice: 1,
    },
    arcana: {
    ...
    banish: {
        ...
        name: "Banish",
        rarity: "uncommon",
        description: "If your {first discard} is one rune, {destroy it} and gain {gold:4}.",
        cost: 4,
        sellPrice: 2,
    },
    magic_mirror: {
    ...
    ahoy: {
        ...
        name: "Ahoy!",
        rarity: "uncommon",
        description: "Earn {gold:5} for each discarded {rune} of this round's element.",
        cost: 4,
        sellPrice: 2,
    },
    chainlink: {
